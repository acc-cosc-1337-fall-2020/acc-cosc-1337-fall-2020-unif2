...
TEST_CASE("Test function reference parameter with string - for ranged")
{
	std::string str = "john";
...
TEST_CASE("Test function reference parameter for vector - for ranged w reference target variable")
{
	std::vector nums {1,4,10};
	std::vector expected_vector {0,0,0};
